...
extern "C"
{
   ...
   */
   ...
   STDW32_DECL int fwprintf(FILE *stream, const wchar_t *format, ...);
   ...
   STDW32_DECL int fgetpos(FILE *stream, fpos_t *pos);
   ...
   STDW32_DECL int snwprintf(wchar_t *str, size_t len, const wchar_t *format, ...);
   STDW32_DECL int sprintf(char *str, const char *format, ...);
   STDW32_DECL int swprintf(wchar_t *str, const wchar_t *format, ...);
   STDW32_DECL char *tmpnam(char *str);
   STDW32_DECL int vfprintf(FILE *stream, const char *format, va_list args);
   STDW32_DECL int vfwprintf(FILE *stream, const wchar_t *format, va_list args);
   STDW32_DECL int vsnprintf(char *str, size_t len, const char *format, va_list args);
   STDW32_DECL int vsnwprintf(wchar_t *str, size_t len, const wchar_t *format, va_list args);
   STDW32_DECL int vsprintf(char *str, const char *format, va_list args);
   STDW32_DECL int vswprintf(wchar_t *str, const wchar_t *format, va_list args);
